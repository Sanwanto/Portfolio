...
$profile = [
    ...
    'bio' => 'Fresh Graduate Teknik Informatika | Web Developer | Passionate about Building Innovative Solutions

Lulusan baru Teknik Informatika dari Universitas Mercu Buana (IPK 3.74) dengan passion yang kuat dalam pengembangan perangkat lunak dan teknologi informasi. Memiliki pengalaman hands-on dalam membangun aplikasi web dan mengelola database, serta didukung oleh sertifikasi internasional di bidang cloud computing dan software engineering.',
...
$projects = [
    [
        ...
        'kategori' => 'Full Stack',
        'deskripsi_singkat' => 'Platform Booking tiket Pesawat.',
        'deskripsi_lengkap' => 'Website dengan memudahkan user untuk memesan tiket pesawat domestik maupun internasional.',
        ...
        'tantangan' => 'Mengintegrasikan berbagai payment gateway dan memastikan keamanan transaksi.',
        'solusi' => 'Implementasi Laravel middleware untuk validasi dan enkripsi data sensitif, serta penggunaan webhook untuk payment confirmation.',
    ...
    [
        'id' => 2,
        'judul' => 'Aplikasi Antrian Pasien Rumah Sakit',
        'kategori' => 'Web App',
        'deskripsi_singkat' => 'Aplikasi manajemen project real-time collaboration.',
        'deskripsi_lengkap' => 'Sistem Antrian yang dibuat untuk memudahkan pasien mendaptkan antrian.',
        ...
        'tantangan' => 'Sinkronisasi real-time antar multiple users tanpa lag.',
        'solusi' => 'Menggunakan Socket.io untuk WebSocket connection dan optimasi database query dengan indexing.',
