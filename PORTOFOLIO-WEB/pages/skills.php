    ...
    <div class="container">
        ...
        <div style="margin-top: 4rem;">
            <div class="section-header">
                ...
                <p class="section-subtitle">Non-technical skills I possess</p>
            </div>
        ...
        <div style="margin-top: 4rem;">
            <div class="section-header">
                ...
                <p class="section-subtitle">Achievements and Experience</p>
            </div>
        ...
        <div style="margin-top: 4rem; text-align: center; background: white; padding: 3rem; border-radius: 20px; box-shadow: 0 10px 40px rgba(0,0,0,0.1);">
            <h3 style="font-size: 2rem; margin-bottom: 1rem;">Interested in Working Together?</h3>
            <p style="color: var(--text-light); margin-bottom: 2rem; max-width: 600px; margin-left: auto; margin-right: auto;">
            I am ready to help bring your dream project to life with the skills and experience I possess.
            </p>
