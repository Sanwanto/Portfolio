    ...
    <div class="container">
        ...
        <div class="contact-grid">
            ...
            <div class="contact-info">
                ...
                Don't hesitate to contact me. I will respond as soon as possible!
                </p>
            ...
            <div class="contact-form">
                ...
                <form id="contact-form">
                    ...
                    <div class="form-group">
                        <label>
                            <i class="fas fa-tag" style="color: var(--primary);"></i> Subject *
                        </label>
                        <input 
                            type="text" 
                            name="subject" 
                    ...
                    <div class="form-group">
                        <label>
                            <i class="fas fa-comment" style="color: var(--primary);"></i> Message *
                        </label>
                        <textarea 
                            name="message" 
                            class="form-control" 
                ...
                <p style="text-align: center; color: var(--text-light); font-size: 0.9rem; margin-top: 1.5rem;">
                    <i class="fas fa-lock"></i> Your information is safe and will not be shared with third parties
                </p>
            </div>
        </div>
            ...
            <div style="max-width: 900px; margin: 0 auto;">
                <div style="background: white; border-radius: 20px; padding: 2.5rem; box-shadow: 0 10px 40px rgba(0,0,0,0.1); margin-bottom: 1.5rem;">
                    <h4 style="font-size: 1.2rem; margin-bottom: 0.8rem; color: var(--primary);">
                        <i class="fas fa-question-circle"></i> How long does it take to complete a project?
                    </h4>
                    <p style="color: var(--text-light); line-height: 1.8;">
                    It depends on the project complexity, typically 2-4 weeks for simple websites and 1-3 months for more complex web applications.
                    </p>
                </div>

                <div style="background: white; border-radius: 20px; padding: 2.5rem; box-shadow: 0 10px 40px rgba(0,0,0,0.1); margin-bottom: 1.5rem;">
                    <h4 style="font-size: 1.2rem; margin-bottom: 0.8rem; color: var(--primary);">
                        <i class="fas fa-question-circle"></i> Do you accept freelance projects?
                    </h4>
                    <p style="color: var(--text-light); line-height: 1.8;">
                    Yes, I am open to freelance projects both short-term and long-term. Please contact me for further discussion.
                    </p>
                </div>

                <div style="background: white; border-radius: 20px; padding: 2.5rem; box-shadow: 0 10px 40px rgba(0,0,0,0.1); margin-bottom: 1.5rem;">
                    <h4 style="font-size: 1.2rem; margin-bottom: 0.8rem; color: var(--primary);">
                        <i class="fas fa-question-circle"></i> What technologies do you use most often?
                    </h4>
                    <p style="color: var(--text-light); line-height: 1.8;">
                    I most often use PHP (Laravel), JavaScript (React/Vue), and MySQL for backend, as well as HTML, CSS, and Tailwind for frontend.
                    </p>
                </div>
            </div>
        </div>
