...
<section style="background: white;">
    <div class="container">
        <div class="section-header">
            ...
            <p class="section-subtitle">Below are some of the best projects I have worked on</p>
        </div>
...
<section>
    <div class="container">
        <div class="section-header">
            ...
            <p class="section-subtitle">Technologies I have mastered</p>
        </div>
...
<section style="background: var(--dark); color: white;">
    <div class="container" style="text-align: center;">
        ...
        Have an interesting project? Let's discuss how I can help make it happen!
        </p>
